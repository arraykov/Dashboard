...
db_file_path = 'files/Database.db'  # Replace with the actual path to your SQLite database

# Connect to the SQLite database
conn = sqlite3.connect(db_file_path)

# Load the tickers from the funds.csv file
funds_df = pd.read_csv('files/Mapping.csv')  # Replace with the actual path to your funds.csv file
